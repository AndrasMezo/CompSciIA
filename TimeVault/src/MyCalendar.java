...
public class MyCalendar extends JFrame {
	...
	private DataModel model, eventList;
	private JPanel gridDates;
	private JButton forward, backwards, create,quit, deleteEvent;
	...
	public MyCalendar(DataModel m) {
		...
		deleteEvent.setBounds(200, 310, 150, 20);
		deleteEvent.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				new AddEventPopUp(eventList);
			}
		});

		quit = new JButton("Quit");
		quit.setBounds(390, 310, 100, 20);
